 ...
 cardElement.addEventListener('change', function(event) {
	 ...
	 if (payment == 2) {
		 if (event.error) {
			 ...
			 $('#addFundsBtn').find('i').removeClass('spinner-border spinner-border-sm align-middle me-1');
		 } else {
 ...
 cardButton.addEventListener('click', function(ev) {
	 ...
	 stripe.createPaymentMethod('card', cardElement, {
		 ...
		 if (result.error) {
			 ...
			 $('#addFundsBtn').find('i').addClass('spinner-border spinner-border-sm align-middle me-1');
