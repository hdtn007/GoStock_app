...
<li><span class="dropdown-item disable-item"><i class="bi bi-cash-stack me-2"></i> {{ trans('misc.balance') }}: {{ Helper::amountFormatDecimal(auth()->user()->balance) }}</span></li>
@endif

<li><a class="dropdown-item" href="{{ url('user/dashboard/add/funds') }}"><i class="bi bi-wallet2 me-2"></i> {{ trans('misc.wallet') }}: {{ Helper::amountFormatDecimal(auth()->user()->funds) }}</a></li>
