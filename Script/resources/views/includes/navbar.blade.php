          ...
          <div class="d-flex align-items-center">
            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0 navbar-session">
              ...
              @endauth
                ...
                <a href="{{ url('notifications') }}" class="text-decoration-none text-muted noty d-block d-lg-none">
    ...
    <div class="offcanvas-body px-0">
        <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-start" id="menu">
          ...
          @endauth
            ...
            @if (auth()->check() && auth()->user()->authorized_to_upload == 'yes')
            <li class="p-3 w-100">
              <a href="{{ url('upload') }}" class="btn btn-custom d-block w-100 animate-up-2" title="{{ trans('users.upload') }}">
                <strong>{{ trans('users.upload') }}</strong>
              </a>
            </li>
          @endif
